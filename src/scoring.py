...
def create_target_face(face_size_cm: int = 40, face_type: str = "WA"):
    ...
    if face_type == "Flint":
        ...
        shapes.append(dict(type="circle", x0=-r3, y0=-r3, x1=r3, y1=r3, fillcolor="black", line_color="black", layer="below"))
        shapes.append(dict(type="circle", x0=-r4, y0=-r4, x1=r4, y1=r4, fillcolor="white", line_color="black", layer="below"))
        shapes.append(dict(type="circle", x0=-r5, y0=-r5, x1=r5, y1=r5, fillcolor="black", line_color="white", layer="below"))
    ...
    fig.update_yaxes(range=[-max_r, max_r], showgrid=False, zeroline=False, visible=False, scaleanchor="x", scaleratio=1)
