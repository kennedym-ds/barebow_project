...
def predict_score_at_distance(
    known_score: float, known_distance_m: float, known_face_cm: int, target_distance_m: float, target_face_cm: int
) -> tuple[float, float]:
    """
...
def calculate_drag_loss(
    ...
    """
    predicted_long, _ = predict_score_at_distance(short_score, short_dist_m, short_face_cm, long_dist_m, long_face_cm)
